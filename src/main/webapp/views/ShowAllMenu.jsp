...
<!-- NAVBAR  -->
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				<li class="nav-item active"><a class="nav-link" href="/views/clientDeshboard.jsp">DashBoard
				...
				<li class="nav-item active"><a class="nav-link" href="/views/clientLogin.jsp">Logout
				</a>
				</ul>
		</div>
	</nav>
  ...
  %>
    <tr>
      ...
      <td><img src="Image\\<%=menuEntity.getMenuImage()%>" width='100'
							height='100'></td>
      <td><%= menuEntity.getMenuPrice() %></td>
      <td><a class ="btn btn-sm btn-success" href="">Edit</a>
   		<a class ="btn btn-sm btn-danger" href="/deleteDish?menuId=<%= menuEntity.getMenuId() %>">Delete</a></td>
       <%}} %>
    </tr>
